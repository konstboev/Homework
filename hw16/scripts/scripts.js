function createCar(color = 'red', consumption = 2.4, tankVolume = 60) {
    ...
    let car = {
        ...
        stopRide() {
            car.ignition = false;
            console.log(`Riding, you passed ${distance} kilometers, you was driving at a speed of ${speed} kilometers p/h, your fuel consumption was ${finalConsumption} liters p/s, you have ${car.gasVolume + finalConsumption} liters of gasoline`);
            clearInterval(_startInterval);
        },
    }
    return car;
